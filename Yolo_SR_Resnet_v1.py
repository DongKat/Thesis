...
!python yolov5/detect.py --weights yolov5/weights/yolo_one_label.pt --imgsz 640 --conf 0.25 --source NomDataset/datasets/mono-domain-datasets/tale-of-kieu/1902/1902-raw-images --save-txt 

#%% Yolo box crop
yolo_box_path = 'yolov5/runs/detect/exp9/labels/'
