...
import torch
from NomDataset import ImageCropDataModule
...
#%%
opt = dict(
    name='ToK1871_SR-RealESRGANx2_RealCE',
    max_epochs=100,
    model_mode='train',
    ...
    data_dirs=dict(
        train=[
            'E:/Datasets/TempResources/ToK1871/ToK1871_mixedSR_crops', 
            'E:/Datasets/TempResources/ToK1871/ToK1871_mixedSR_crops.txt'
        ],
        val=[
            'E:/Datasets/TempResources/ToK1902/ToK1902_SR_crops/Real-ESRGAN/RealESRGAN_x2plus',
            'E:/Datasets/TempResources/ToK1902/ToK1902_crops.txt'
        ],
        # test=[
        #     'E:/Datasets/TempResources/LVT/LVT_SR_crops/Real-ESRGAN/RealESRGAN_x2plus',
        #     'E:/Datasets/TempResources/LVT/LVT_crops.txt'
        # ]
        test = [
            'E:/Datasets/HWDB1.1/tmp/test_sample',
            'E:/Datasets/HWDB1.1/tmp/test_sample.txt'
        ]
    ),
